...
class WalletService extends BaseService {
  static const String _valuationUrl = 'https://getusertokenvaluations-obpz3whteq-uc.a.run.app';

  /// Busca o histórico de valorização da carteira do usuário.
  static Future<ApiResponse<GetUserTokenValuationsResponse>> getPortfolioValuation({
