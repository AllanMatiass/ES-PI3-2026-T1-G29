...
void main() {
  group('TransactionService - Testes Unitários', () {
    ...
    final Map<String, dynamic> tTransactionItemPayload = {
      ...
      'buyer': {'id': 'buyer_roberto', 'name': 'Roberto', 'type': 'USER'},
      'seller': {
        'id': 'seller_company',
        'name': 'Angels Corp',
        'type': 'COMPANY',
    ...
    test(
      'getUserTransactions - Deve carregar transações com os parâmetros padrão com sucesso',
      () async {
    ...
    //
    test(
      'getUserTransactions - Deve incluir o lastTransactionId no payload quando fornecido',
      () async {
        final tResponsePayload = {
          'result': {
    ...
    test(
      'getUserTransactions - Deve mapear corretamente quando o resultado vier sem transações',
      () async {
        final tEmptyPayload = {
          'result': {'lastTransactionId': null, 'transactions': []},
        };
    ...
    test(
      'getUserTransactions - Deve repassar o erro estruturado caso a Cloud Function falhe',
      () async {
