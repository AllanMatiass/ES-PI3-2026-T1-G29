...
void main() {
  group('EventService - Testes Unitários', () {
    ...
    final Map<String, dynamic> tEventItemPayload = {
      ...
      'content': 'O especialista Roberto assume a gestão da equipe de engenharia para acelerar entregas.',
    ...
    test('listEvents - deve obter a lista de eventos filtrados e paginados com sucesso', () async {
    ...
    test('listEvents - deve funcionar perfeitamente quando os filtros opcionais forem nulos', () async {
      final tResponsePayload = {
        'result': {
          'events': [tEventItemPayload],
          'lastEventId': null
    ...
    test('news_sentiment - deve validar todas as faixas do enum newssentiment com base no delta', () {
    ...
    test('listEvents - deve propagar a falha estruturada caso a cloud function retorne erro', () async {
      ...
      expect(result.message, 'erro ao consultar o banco de dados de eventos.');
    });
  });
}